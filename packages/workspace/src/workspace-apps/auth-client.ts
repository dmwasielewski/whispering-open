 ...
 *
 * Pinned here so workspace stays a standalone local-first primitive: a
 * desktop or CLI consumer that never signs in does not need to install an
 * auth package. Hosted auth clients can still pass their state through this
 * structural contract.
 */
 ...
 * matches can be passed to `startDaemonWorkspaceApps`.
 *
 ...
 * lets this package compile without depending on a concrete auth package.
 */
